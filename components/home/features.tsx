...
const featureList = [
  {
    ...
    description:
      "Dyo provides powerful analytics for your links, including geolocation, device, browser, and referrer information.",
    cta: (
      <Link
  ...
  },
  {
    ...
    description:
      "Dyo offers free custom domains on all plans - start personalizing your links today.",
    cta: (
      <a
  ...
  },
  {
    ...
    description:
      "QR codes and short links are like peas in a pod. That's why we've built a QR code generator right into Dyo.",
  ...
  },
  {
    ...
    description:
      "With Dyo, you can invite unlimited team members to collaborate on your project for free - no more sharing logins via Google groups.",
    cta: (
      <a
        href="https://app.dyo.at"
        target="_blank"
      ...
      <MaxWidthWrapper className="py-10">
        <div className="mx-auto max-w-md text-center sm:max-w-xl">
          ...
          <p className="mt-5 text-gray-600 sm:text-lg">
            Dyo is more than just a link shortener. We've built a suite of
