    ...
    <div className="max-w-md sm:max-w-lg mt-20 mb-10 text-center mx-auto sm:px-0 px-2.5">
      ...
      <div className="mt-10 flex space-x-4 max-w-fit mx-auto">
        <Link href="https://app.dyo.at/register">
          <a className="py-2 px-5 bg-black hover:bg-white shadow-lg rounded-full border border-black text-sm text-white hover:text-black transition-all">
            Start For Free
          </a>
        </Link>
        <a
          className="flex justify-center items-center space-x-2 py-2 px-5 bg-white shadow-lg rounded-full border border-gray-300 hover:border-gray-800 transition-all"
          href="https://dyo.at/github"
          target="_blank"
          rel="noreferrer"
        >
