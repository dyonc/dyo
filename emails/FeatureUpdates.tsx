    ...
    <Mjml>
      ...
      <MjmlBody width={500}>
        <MjmlWrapper cssClass="container">
          <Header title="New Features from Dyo" />
          ...
          <MjmlSection cssClass="smooth">
            <MjmlColumn>
              <MjmlText cssClass="paragraph">
                Happy Wednesday! Here are some of the new features
                that were recently added to Dyo:
              </MjmlText>
              <Divider bottomPadding />
              <MjmlText cssClass="subtitle">1. Links with superpowers</MjmlText>

              <MjmlText cssClass="paragraph">
                With Dyo, you can create links with:
              </MjmlText>
              ...
              <MjmlText cssClass="paragraph">
                See{" "}
                <a href="https://dyo.at#features" target="_blank">
                  how this works
                </a>
                .
              </MjmlText>
              ...
              <MjmlText cssClass="paragraph">
                With Dyo, you can do that for $0/mo.
              </MjmlText>
              <MjmlText cssClass="paragraph">
                Start{" "}
              ...
              <MjmlText cssClass="paragraph">
                Dyo provides powerful analytics for your links:
              </MjmlText>
              <MjmlText cssClass="li">
              ...
              <MjmlText cssClass="paragraph">
                ...
                <a href="https://dyo.at/stats/github" target="_blank">
                  here
                </a>
                .
              </MjmlText>
              ...
              <MjmlText cssClass="paragraph">
                Dyo allows you to generate QR codes of your short links for
                free.
              </MjmlText>
              <MjmlText cssClass="paragraph">
              ...
              <MjmlText cssClass="paragraph">
                ...
                to invite your friends & teammates to your Dyo project.
              </MjmlText>
              <MjmlText cssClass="paragraph">
                With Dyo, you get unlimited team invites for every project – no
