...
export default function Placeholder({ domain }: { domain: string }) {
  ...
  return (
    <div className="flex h-screen flex-col items-center">
      <Meta
        title={`${domain.toUpperCase()} - A Dyo Custom Domain`}
        description={`${domain.toUpperCase()} is a custom domain on Dyo - an open-source link management tool for modern marketing teams to create, share, and track short links.`}
      />
      <Background />
      <motion.div
        className="z-10"
        ...
        {showText && (
          ...
          >
            ...
            <motion.p
              ...
              variants={STAGGER_CHILD_VARIANTS}
            >
              <InlineSnippet>{domain}</InlineSnippet> is a custom domain on Dyo
